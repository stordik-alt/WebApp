...
export function ResideoLogo({
  ...
  const symbol = (
    <span
      aria-hidden
      className="resideo-logo-symbol relative flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-[18px] border border-primary/70 bg-[linear-gradient(145deg,hsl(var(--primary)/0.2),hsl(var(--sidebar)/0.96)_52%,hsl(var(--primary)/0.08))] shadow-[0_0_0_1px_hsl(var(--primary)/0.08),0_10px_28px_-8px_hsl(var(--primary)/0.75),inset_0_1px_0_hsl(0_0%_100%_/_0.08),inset_0_-10px_18px_hsl(0_0%_0%_/_0.24)]"
    >
      <span className="resideo-logo-inner absolute inset-[5px] rounded-[14px] bg-[radial-gradient(circle_at_35%_25%,hsl(var(--primary)/0.22),transparent_42%),linear-gradient(160deg,hsl(var(--primary)/0.12),transparent_65%)] shadow-[inset_0_2px_7px_hsl(0_0%_0%_/_0.28)]" />
