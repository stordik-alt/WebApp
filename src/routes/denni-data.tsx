      ...
      <div className="space-y-5">
        ...
        <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            { label: "Průměrný výkon", value: summary.performance == null ? "–" : `${fmt(summary.performance)} %`, detail: "bez horního limitu", tone: metricTone(summary.performance) },
