-- Verze 2.0 AUTO
-- Hardening after the first live migration pass.
-- Keeps the requested batch size immutable, fixes RPC JSONB de-duplication,
-- and makes rejected items count as processed errors.
