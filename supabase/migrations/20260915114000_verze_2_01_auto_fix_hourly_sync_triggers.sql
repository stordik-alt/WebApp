-- Verze 2.01 AUTO – repair hourly multi-product synchronization and trigger wrappers.
-- Fixes the PostgreSQL trigger invocation and avoids an invalid ON CONFLICT target
...
grant execute on function public.trg_sync_import_item_hourly_from_ocr_2_01() to authenticated;
